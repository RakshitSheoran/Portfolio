...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      init(container) {
        this.container = container;
        this.docTarget = document; // Change from container.ownerDocument
        this.listenerTarget = window; // Change to window directly
      ...
      onDocumentMouseMove(event) {
        // Remove the hover check - always respond to mouse
...
`;
    ...
    class WebGLManager {
      ...
      init() {
        ...
        canvas.style.zIndex = "1"; // Positive but low z-index
